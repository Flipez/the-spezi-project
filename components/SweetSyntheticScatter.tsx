    ...
    <div className="mt-10">
      ...
      <ResponsiveContainer width="100%" height={360}>
        <ScatterChart margin={{ top: 10, right: 20, left: 0, bottom: 30 }}>
          ...
          <YAxis type="number" dataKey="Synthetic" name="Synthetic" domain={[0, 5]} tickCount={6} />
          <ZAxis
            type="number"
            dataKey="Rating"
          ...
          <Tooltip
            formatter={(value, name) =>
              name === 'Rating' && typeof value === 'number' ? value.toFixed(1) : value
            }
          />
          <Legend />
          <Scatter name="Cola" data={colas} fill="#3b82f6" /* blue */ />
          <Scatter name="Spezi" data={spezis} fill="#f97316" /* orange */ />
        </ScatterChart>
      </ResponsiveContainer>
    </div>
  );
